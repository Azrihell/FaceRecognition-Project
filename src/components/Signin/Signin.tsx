    ...
    <div className="sans-serif w-90 white mw6 center relative cover bg-top mt2">
      ...
      <div className="relative pa4 pa5-m">
        ...
        <form>
          ...
          <div>
            <button onClick={() => navigate('/')} className="input-reset db w-100 light-gray f6 b ttu tracked pv3 ph3 pointer bg-dark-blue hover-bg-blue bn br-pill">Sign In</button>
          </div>
        </form>
